...
var x__4138__auto__ = diff;
var y__4139__auto__ = (pucks.globals.two_pi - diff);
 ...
 */
pucks.util.wrap_position = (function pucks$util$wrap_position(p__5257){
var vec__5258 = p__5257;
var x = cljs.core.nth.call(null,vec__5258,(0),null);
var y = cljs.core.nth.call(null,vec__5258,(1),null);
 ...
 */
pucks.util.relative_position__GT_rotation = (function pucks$util$relative_position__GT_rotation(p__5261){
var vec__5262 = p__5261;
var x = cljs.core.nth.call(null,vec__5262,(0),null);
var y = cljs.core.nth.call(null,vec__5262,(1),null);
if((((x === (0))) && ((y === (0))))){
 ...
 * Returns a rotation corresponding to a provided [x y] relative position.
 */
pucks.util.direction__GT_rotation = (function pucks$util$direction__GT_rotation(p__5265){
var vec__5266 = p__5265;
var x = cljs.core.nth.call(null,vec__5266,(0),null);
var y = cljs.core.nth.call(null,vec__5266,(1),null);
...
return cljs.core.assoc.call(null,agent,new cljs.core.Keyword(null,"position","position",-2011731912),(function (){var vec__5269 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(agent);
var ax = cljs.core.nth.call(null,vec__5269,(0),null);
var ay = cljs.core.nth.call(null,vec__5269,(1),null);
var vec__5272 = position;
var px = cljs.core.nth.call(null,vec__5272,(0),null);
var py = cljs.core.nth.call(null,vec__5272,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.abs.call(null,(ax - px)) < (function (){var x__4138__auto__ = (ax + (sz - px));
var y__4139__auto__ = (px + (sz - ax));
return ((x__4138__auto__ < y__4139__auto__) ? x__4138__auto__ : y__4139__auto__);
})()))?(ax - px):(((ax > px))?(- (px + (sz - ax))):(ax + (sz - px)))),(((quil.core.abs.call(null,(ay - py)) < (function (){var x__4138__auto__ = (ay + (sz - py));
var y__4139__auto__ = (py + (sz - ay));
return ((x__4138__auto__ < y__4139__auto__) ? x__4138__auto__ : y__4139__auto__);
...
return cljs.core.assoc.call(null,cljs.core.assoc.call(null,cljs.core.assoc.call(null,cljs.core.assoc.call(null,a,new cljs.core.Keyword(null,"neighbors","neighbors",1430436473),cljs.core.mapv.call(null,(function (p1__5275_SHARP_){
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"abbrev","abbrev",10803847),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__5275_SHARP_)], null);
}),new cljs.core.Keyword(null,"neighbors","neighbors",1430436473).cljs$core$IFn$_invoke$arity$1(a))),new cljs.core.Keyword(null,"sensed","sensed",1518013926),cljs.core.mapv.call(null,(function (p1__5276_SHARP_){
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"abbrev","abbrev",10803847),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__5276_SHARP_)], null);
}),new cljs.core.Keyword(null,"sensed","sensed",1518013926).cljs$core$IFn$_invoke$arity$1(a))),new cljs.core.Keyword(null,"overlaps","overlaps",1398230580),cljs.core.mapv.call(null,(function (p1__5277_SHARP_){
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"abbrev","abbrev",10803847),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__5277_SHARP_)], null);
...
return cljs.core.mapv.call(null,pucks.util._PERCENT_1,pucks.util._PERCENT_2);
});
/**
 * Returns sequence s without the first instance of item.
 */
pucks.util.remove_one = (function pucks$util$remove_one(item,s){
var vec__5281 = cljs.core.split_with.call(null,(function (p1__5280_SHARP_){
return (!(cljs.core._EQ_.call(null,item,p1__5280_SHARP_)));
}),s);
var without_item = cljs.core.nth.call(null,vec__5281,(0),null);
var with_item = cljs.core.nth.call(null,vec__5281,(1),null);
