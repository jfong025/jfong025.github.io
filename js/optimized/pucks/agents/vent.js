...
var vec__11476 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(p);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11476,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11476,(1),null);
var radius = cljs.core.cst$kw$radius.cljs$core$IFn$_invoke$arity$1(p);
var vec__11479 = cljs.core.cst$kw$color.cljs$core$IFn$_invoke$arity$1(p);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11479,(0),null);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11479,(1),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11479,(2),null);
var vec__11482 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(238),(118),(0)], null);
var core_r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11482,(0),null);
var core_g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11482,(1),null);
var core_b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11482,(2),null);
...
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$transfer,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var iter__4523__auto__ = (function pucks$agents$vent$vent_proposals_$_iter__11485(s__11486){
return (new cljs.core.LazySeq(null,(function (){
var s__11486__$1 = s__11486;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__11486__$1);
if(temp__5735__auto__){
var s__11486__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__11486__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__11486__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__11488 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__11487 = (0);
while(true){
if((i__11487 < size__4522__auto__)){
var recipient = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__11487);
cljs.core.chunk_append(b__11488,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$self,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p),cljs.core.cst$kw$other,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(recipient),cljs.core.cst$kw$bid,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$energy,0.01], null),cljs.core.cst$kw$ask,cljs.core.PersistentArrayMap.EMPTY], null));

var G__11489 = (i__11487 + (1));
i__11487 = G__11489;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__11488),pucks$agents$vent$vent_proposals_$_iter__11485(cljs.core.chunk_rest(s__11486__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__11488),null);
}
} else {
var recipient = cljs.core.first(s__11486__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$self,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p),cljs.core.cst$kw$other,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(recipient),cljs.core.cst$kw$bid,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$energy,0.01], null),cljs.core.cst$kw$ask,cljs.core.PersistentArrayMap.EMPTY], null),pucks$agents$vent$vent_proposals_$_iter__11485(cljs.core.rest(s__11486__$2)));
}
} else {
return null;
}
