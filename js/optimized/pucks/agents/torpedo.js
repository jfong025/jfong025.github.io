...
return cljs.core.chunk_cons(cljs.core.chunk(b__11377),pucks$agents$torpedo$torpedo_proposals_$_iter__11374(cljs.core.chunk_rest(s__11375__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__11377),null);
}
} else {
var victim = cljs.core.first(s__11375__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$self,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(p),cljs.core.cst$kw$other,cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(victim),cljs.core.cst$kw$bid,cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$ask,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$energy,1.0], null)], null),pucks$agents$torpedo$torpedo_proposals_$_iter__11374(cljs.core.rest(s__11375__$2)));
}
} else {
return null;
}
